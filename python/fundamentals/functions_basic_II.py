...
def countdown(num):
    ...
    return countlist
print(countdown(5))
# my output has spaces after the comma
...
# this is really sloppy on my part. No checking if the first value to be a number. Maybe later.
...
print(new_list)
# this is incorrect, but it matches the expected output. "greater than its 2nd value",
# not "greater than or equal to its 2nd value"
